...
class X509
{
    ...
    public function loadCA($cert)
    {
        ...
        $cert = $this->module->loadX509($cert);
        if (!$cert) {
            $this->dn = $olddn;
    ...
    public function sign(X509 $issuer, X509 $subject)
    {
        ...
        $this->module->loadX509($this->saveX509($this->currentCert));
    ...
    public function signCSR()
    {
        ...
        $this->module->loadCSR($this->saveCSR($this->currentCert));
    ...
    public function signSPKAC()
    {
        ...
        $this->module->loadSPKAC($this->saveSPKAC($this->currentCert));
    ...
    public function signCRL(X509 $issuer, X509 $crl)
    {
        ...
        $tbsCertList = $this->currentCert['tbsCertList'];
        $this->module->loadCRL($this->saveCRL($this->currentCert));
