    ...
    GetQuotaProjectInterface
{
    ...
    public function fetchAuthToken(callable $httpHandler = null)
    {
        ...
        if ($this->targetAudience) {
            return $this->module->lastReceivedToken = ['id_token' => $response];
        }
        ...
        $this->module->lastReceivedToken = $json;
    ...
    {
        if ($this->module->lastReceivedToken) {
            if (array_key_exists('id_token', $this->module->lastReceivedToken)) {
                return $this->module->lastReceivedToken;
            }

            return [
                'access_token' => $this->module->lastReceivedToken['access_token'],
                'expires_at' => $this->module->lastReceivedToken['expires_at']
            ];
        }
