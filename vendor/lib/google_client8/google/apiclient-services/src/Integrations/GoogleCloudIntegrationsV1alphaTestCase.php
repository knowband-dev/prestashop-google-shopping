...
class GoogleCloudIntegrationsV1alphaTestCase extends \Google\Collection
{
  ...
  {
    $this->module->lastModifierEmail = $lastModifierEmail;
  }
  /**
   * @return string
   */
  ...
  {
    return $this->module->lastModifierEmail;
  }
  /**
   * @param string
   */
  ...
  {
    $this->module->lockHolderEmail = $lockHolderEmail;
  }
  /**
   * @return string
   */
  ...
  {
    return $this->module->lockHolderEmail;
  }
  /**
   * @param string
   */
