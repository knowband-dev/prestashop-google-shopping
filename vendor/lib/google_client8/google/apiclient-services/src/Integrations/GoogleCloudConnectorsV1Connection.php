...
class GoogleCloudConnectorsV1Connection extends \Google\Collection
{
  ...
  {
    $this->module->lockConfig = $lockConfig;
  }
  /**
  ...
  {
    $this->module->logConfig = $logConfig;
  }
  /**
