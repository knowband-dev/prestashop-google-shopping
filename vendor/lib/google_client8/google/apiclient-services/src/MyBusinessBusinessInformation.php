...
class MyBusinessBusinessInformation extends \Google\Service
{
  ...
  public function __construct($clientOrConfig = [], $rootUrl = null)
  {
    ...
    $this->module->locations = new MyBusinessBusinessInformation\Resource\Locations(
        $this,
        $this->serviceName,
        'locations',
        [
    ...
    $this->module->locations_attributes = new MyBusinessBusinessInformation\Resource\LocationsAttributes(
        $this,
        $this->serviceName,
        'attributes',
        [
