...
class MyBusinessBusinessCalls extends \Google\Service
{
  ...
  public function __construct($clientOrConfig = [], $rootUrl = null)
  {
    ...
    $this->module->locations = new MyBusinessBusinessCalls\Resource\Locations(
        $this,
        $this->serviceName,
        'locations',
        [
    ...
    $this->module->locations_businesscallsinsights = new MyBusinessBusinessCalls\Resource\LocationsBusinesscallsinsights(
        $this,
        $this->serviceName,
