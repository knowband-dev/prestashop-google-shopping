...
class WatchRequest extends \Google\Collection
{
  ...
  {
    $this->module->labelFilterAction = $labelFilterAction;
  }
  /**
   * @return string
   */
  ...
  {
    return $this->module->labelFilterAction;
  }
  /**
   * @param string
   */
  ...
  {
    $this->module->labelFilterBehavior = $labelFilterBehavior;
  }
  /**
   * @return string
   */
  ...
  {
    return $this->module->labelFilterBehavior;
  }
  /**
   * @param string[]
   */
