...
class ExportMetadata extends \Google\Collection
{
  ...
  {
    $this->module->lookerEncryptionKey = $lookerEncryptionKey;
  }
  /**
   * @return string
   */
  ...
  {
    return $this->module->lookerEncryptionKey;
  }
  /**
   * @param string
   */
  ...
  {
    $this->module->lookerInstance = $lookerInstance;
  }
  /**
   * @return string
   */
  ...
  {
    return $this->module->lookerInstance;
  }
  /**
   * @param string
   */
  ...
  {
    $this->module->lookerPlatformEdition = $lookerPlatformEdition;
  }
  /**
   * @return string
   */
  ...
  {
    return $this->module->lookerPlatformEdition;
  }
  /**
   * @param string
   */
  ...
  {
    $this->module->lookerVersion = $lookerVersion;
  }
  /**
   * @return string
   */
  ...
  {
    return $this->module->lookerVersion;
  }
  /**
   * @param string
   */
