...
class Instance extends \Google\Model
{
  ...
  {
    $this->module->lastDenyMaintenancePeriod = $lastDenyMaintenancePeriod;
  }
  /**
   * @return DenyMaintenancePeriod
   */
  ...
  {
    return $this->module->lastDenyMaintenancePeriod;
  }
  /**
   * @param string
   */
  ...
  {
    $this->module->lookerUri = $lookerUri;
  }
  /**
   * @return string
   */
