...
class MyBusinessAccountManagement extends \Google\Service
{
  ...
  public function __construct($clientOrConfig = [], $rootUrl = null)
  {
    ...
    $this->module->locations = new MyBusinessAccountManagement\Resource\Locations(
        $this,
        $this->serviceName,
        'locations',
        [
    ...
    $this->module->locations_admins = new MyBusinessAccountManagement\Resource\LocationsAdmins(
        $this,
        $this->serviceName,
        'admins',
        [
