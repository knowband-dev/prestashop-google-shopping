...
class Product extends \Google\Collection
{
  ...
  {
    $this->module->lifestyleImageLinks = $lifestyleImageLinks;
  }
  /**
   * @return string[]
   */
  ...
  {
    return $this->module->lifestyleImageLinks;
  }
  /**
   * @param string
   */
  ...
  {
    $this->module->loyaltyPoints = $loyaltyPoints;
  }
  /**
  ...
  {
    return $this->module->loyaltyPoints;
  }
  /**
   * @param string
   */
