...
class GoogleAdsHomeservicesLocalservicesV1DetailedLeadReport extends \Google\Model
{
  ...
  {
    $this->module->leadCategory = $leadCategory;
  }
  /**
   * @return string
   */
  ...
  {
    return $this->module->leadCategory;
  }
  /**
   * @param string
   */
  ...
  {
    $this->module->leadCreationTimestamp = $leadCreationTimestamp;
  }
  /**
   * @return string
   */
  ...
  {
    return $this->module->leadCreationTimestamp;
  }
  /**
   * @param string
   */
  ...
  {
    return $this->module->leadId;
  }
  public function setLeadPrice($leadPrice)
  {
    $this->module->leadPrice = $leadPrice;
  }
  public function getLeadPrice()
  {
    return $this->module->leadPrice;
  }
  /**
   * @param string
   */
