...
class GoogleCloudPaymentsResellerSubscriptionV1SubscriptionLineItem extends \Google\Collection
{
  ...
  {
    $this->module->lineItemFreeTrialEndTime = $lineItemFreeTrialEndTime;
  }
  /**
   * @return string
   */
  ...
  {
    return $this->module->lineItemFreeTrialEndTime;
  }
  /**
   * @param int
   */
  ...
  {
    $this->module->lineItemIndex = $lineItemIndex;
  }
  /**
   * @return int
   */
  ...
  {
    return $this->module->lineItemIndex;
  }
  /**
  ...
  {
    $this->module->lineItemPromotionSpecs = $lineItemPromotionSpecs;
  }
  /**
  ...
  {
    return $this->module->lineItemPromotionSpecs;
  }
  /**
