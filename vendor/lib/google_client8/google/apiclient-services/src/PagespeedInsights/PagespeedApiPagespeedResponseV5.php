...
class PagespeedApiPagespeedResponseV5 extends \Google\Model
{
  ...
  {
    $this->module->lighthouseResult = $lighthouseResult;
  }
  /**
  ...
  {
    return $this->module->lighthouseResult;
  }
  /**
  ...
  {
    $this->module->loadingExperience = $loadingExperience;
  }
  /**
  ...
  {
    return $this->module->loadingExperience;
  }
  /**
   * @param PagespeedApiLoadingExperienceV5
   */
