...
class RendererFormattedStrings extends \Google\Model
{
  ...
  {
    $this->module->labDataTitle = $labDataTitle;
  }
  /**
   * @return string
   */
  ...
  {
    return $this->module->labDataTitle;
  }
  /**
   * @param string
   */
  ...
  {
    $this->module->lsPerformanceCategoryDescription = $lsPerformanceCategoryDescription;
  }
  /**
   * @return string
   */
  ...
  {
    return $this->module->lsPerformanceCategoryDescription;
  }
  /**
   * @param string
   */
