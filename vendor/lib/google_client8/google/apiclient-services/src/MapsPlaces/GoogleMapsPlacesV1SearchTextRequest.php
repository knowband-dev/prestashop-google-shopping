...
class GoogleMapsPlacesV1SearchTextRequest extends \Google\Collection
{
  ...
  {
    $this->module->locationBias = $locationBias;
  }
  /**
  ...
  {
    return $this->module->locationBias;
  }
  /**
  ...
  {
    $this->module->locationRestriction = $locationRestriction;
  }
  /**
  ...
  {
    return $this->module->locationRestriction;
  }
  /**
   * @param int
   */
