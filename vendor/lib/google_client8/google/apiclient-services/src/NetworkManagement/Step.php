...
class Step extends \Google\Model
{
  ...
  {
    $this->module->loadBalancer = $loadBalancer;
  }
  /**
  ...
  {
    return $this->module->loadBalancer;
  }
  /**
  ...
  {
    $this->module->loadBalancerBackendInfo = $loadBalancerBackendInfo;
  }
  /**
  ...
  {
    return $this->module->loadBalancerBackendInfo;
  }
  /**
   * @param NatInfo
   */
