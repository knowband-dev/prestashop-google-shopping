...
class Endpoint extends \Google\Model
{
  ...
  {
    $this->module->loadBalancerId = $loadBalancerId;
  }
  /**
   * @return string
   */
  ...
  {
    return $this->module->loadBalancerId;
  }
  /**
   * @param string
   */
  ...
  {
    $this->module->loadBalancerType = $loadBalancerType;
  }
  /**
   * @return string
   */
  ...
  {
    return $this->module->loadBalancerType;
  }
  /**
   * @param string
   */
