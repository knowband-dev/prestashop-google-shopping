...
class Promotion extends \Google\Collection
{
  ...
  {
    $this->module->limitQuantity = $limitQuantity;
  }
  /**
   * @return int
   */
  ...
  {
    return $this->module->limitQuantity;
  }
  /**
   * @param PriceAmount
   */
  ...
  {
    $this->module->limitValue = $limitValue;
  }
  /**
   * @return PriceAmount
   */
  ...
  {
    $this->module->longTitle = $longTitle;
  }
  /**
   * @return string
   */
