...
class DeveloperMetadataLookup extends \Google\Model
{
  ...
  {
    $this->module->locationMatchingStrategy = $locationMatchingStrategy;
  }
  /**
   * @return string
   */
  ...
  {
    return $this->module->locationMatchingStrategy;
  }
  /**
   * @param string
   */
  ...
  {
    $this->module->locationType = $locationType;
  }
  /**
   * @return string
   */
  ...
  {
    return $this->module->locationType;
  }
  /**
   * @param int
   */
